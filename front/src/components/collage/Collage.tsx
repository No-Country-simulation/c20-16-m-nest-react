export default function Collage() {
  return (
    <section className="grid grid-cols-2 md:grid-cols-3 grid-rows-2	gap-5 items-center pt-12 max-w-[1440px] mx-auto">
      <div className="w-full h-[305px] bg-red-300 rounded-2xl shadow-md overflow-hidden">
        <img
      ...
      <div className="w-full h-[305px] bg-red-300 col-span-2 rounded-2xl overflow-hidden shadow-md">
        <img
